...
export declare class ConnectApi extends EventEmitter {
    ...
    */
     ...
     */
    getResourceValue(deviceId: string, path: string, cacheOnly?: boolean, noResponse?: boolean): Promise<string>;
    /**
     * Gets the value of a resource
     *
     * __Note:__ This method requires a notification channel to be set up
     ...
     */
    getResourceValue(deviceId: string, path: string, cacheOnly?: boolean, noResponse?: boolean, callback?: CallbackFn<string>): void;
    /**
     ...
     */
    getAccountMetrics(options: MetricsStartEndOptions | MetricsPeriodOptions): Promise<Array<Metric>>;
    /**
     * Get account-specific metrics
     *
     * Example: (The following will retrieve metrics regarding pending and failed device registrations in the last day)
     ...
     */
    getAccountMetrics(options: MetricsStartEndOptions | MetricsPeriodOptions, callback: CallbackFn<Array<Metric>>): void;
    /**
     * Get metrics
     *
     * Example: (The following will retrieve metrics regarding pending and failed device registrations in the last day)
     ...
     * @returns Promise of metrics
     */
    getMetrics(options: MetricsStartEndOptions | MetricsPeriodOptions): Promise<Array<Metric>>;
    /**
     * Get metrics
     *
     * Example: (The following will retrieve metrics regarding pending and failed device registrations in the last day)
     ...
     * @param callback A function that is passed the return arguments (error, metrics)
     */
    getMetrics(options: MetricsStartEndOptions | MetricsPeriodOptions, callback: CallbackFn<Array<Metric>>): void;
}
