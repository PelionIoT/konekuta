...
var ResourcesApi = (function (_super) {
     ...
     */
    ResourcesApi.prototype.v3DevicesDeviceIdCachedResourcesResourcePathDelete = function (endpointName, resourcePath, noResp, pri, callback) {
     ...
     */
    ResourcesApi.prototype.v3DevicesDeviceIdCachedResourcesResourcePathGet = function (endpointName, resourcePath, cacheOnly, pri, callback) {
        // verify required parameter "endpointName" is set
        if (endpointName === null || endpointName === undefined) {
            if (callback) {
                callback(new sdkError_1.SDKError("Required parameter 'endpointName' missing."));
     ...
     * @param pri Priority message. Adds traffic-class for outgoing IPv6 message (only UDP). Network should this header and  Accepted values are AF11, AF12, AF13, AF21, AF22, AF23, AF31, AF32, AF33, AF41, AF42, AF43, VA, EF, CS0, CS1, CS2,CS3, CS4, CS5, CS6, CS7 and DF. Numeric values 0-7 are interpreted as matching to the corresponding CS value. Optional. Default: 0
     */
    ResourcesApi.prototype.v3DevicesDeviceIdCachedResourcesResourcePathPost = function (endpointName, resourcePath, resourceFunction, noResp, pri, callback) {
        // verify required parameter "endpointName" is set
        if (endpointName === null || endpointName === undefined) {
            if (callback) {
                callback(new sdkError_1.SDKError("Required parameter 'endpointName' missing."));
     ...
     * @param pri Priority message. Adds traffic-class for outgoing IPv6 message (only UDP). Network should this header and  Accepted values are AF11, AF12, AF13, AF21, AF22, AF23, AF31, AF32, AF33, AF41, AF42, AF43, VA, EF, CS0, CS1, CS2,CS3, CS4, CS5, CS6, CS7 and DF. Numeric values 0-7 are interpreted as matching to the corresponding CS value. Optional. Default: 0
     */
    ResourcesApi.prototype.v3DevicesDeviceIdCachedResourcesResourcePathPut = function (endpointName, resourcePath, resourceValue, pri, callback) {
        // verify required parameter "endpointName" is set
        if (endpointName === null || endpointName === undefined) {
            if (callback) {
                callback(new sdkError_1.SDKError("Required parameter 'endpointName' missing."));
