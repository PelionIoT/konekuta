...
var AccountApi = (function (_super) {
     ...
     * @param interval Group data by this interval in minutes, hours, days or weeks. Sample values: 5m, 2h, 3d, 4w. Allowed range is 1[h/d/w] - 9999[h/d/w] or 5[m] - 9999[m].
     ...
     * @param period Period. Fetch the data for the period in minutes, hours, days or weeks. Sample values: 5m, 2h, 3d, 4w. The parameter is not mandatory, if the start and end time are specified. Allowed range is 1[h/d/w] - 9999[h/d/w] or 5[m] - 9999[m].
     */
    AccountApi.prototype.v3MetricsGet = function (include, interval, authorization, start, end, period, callback) {
...
var StatisticsApi = (function (_super) {
     ...
     * @param period Period. Fetch the data for the period in minutes, hours, days or weeks. Sample values: 5m, 2h, 3d, 4w. The parameter is not mandatory, if the start and end time are specified. Allowed range is 1[h/d/w] - 9999[h/d/w] or 5[m] - 9999[m].
     */
    StatisticsApi.prototype.v3MetricsGet = function (include, interval, authorization, start, end, period, callback) {
        // verify required parameter "include" is set
        if (include === null || include === undefined) {
            if (callback) {
                callback(new sdkError_1.SDKError("Required parameter 'include' missing."));
